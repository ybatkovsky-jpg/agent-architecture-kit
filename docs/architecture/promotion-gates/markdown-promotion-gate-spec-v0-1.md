# Markdown Promotion Gate Spec v0.1

## 1. Purpose

This spec turns repo-promotion guidance from prose into a bounded decision contract that later implementation tasks can execute consistently.
...
```json
{
  "candidate": "task-manager/artifacts/example-architecture-note.md",
  ...
  "suggested_destination": {
    ...
    "path": "docs/architecture/promotion-gates/markdown-promotion-gate-spec-v0-1.md",
    "bucket": "docs/architecture/promotion-gates"
  },
...
- matches the current bounded-completion workflow.
...
- `examples/promotion-gate/fixtures/` or equivalent fixtures folder
...
- [x] Implementation plan is sliced for later work.

### 11.2 Implementation-ready acceptance
...
5. Should a future v0.2 support a `sanitization_hints` field with concrete rewrite suggestions?
