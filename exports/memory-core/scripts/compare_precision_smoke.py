...
pairs = [
    ...
    ('task-108-db-backed-retrieval-baseline', 'query-task-108-db.json', 'query-task-108-local.json'),
    ('memory rollout plan', 'query-memory-rollout-plan-db.json', 'query-memory-rollout-plan-local.json'),
]
summary = []
