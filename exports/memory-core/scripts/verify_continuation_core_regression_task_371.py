...
DEFAULT_FIXTURE = ROOT / "fixtures" / "continuation-core-regression-task-371" / "cases.json"
DEFAULT_OUTPUT = ROOT / "outputs" / "task-371-continuation-core-regression-2026-05-12"
...
def evaluate_case(case: dict[str, Any], payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "top_item": {"workspace_path": top_path, "authority": top_authority, "match_reason": top_match_reason},
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Verify continuation-core regression fixtures split from task #371")
